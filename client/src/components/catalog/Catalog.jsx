  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white flex">
      ...
      <aside className="w-64 bg-[#111111] border-r border-gray-800 p-6">
        <h2 className="text-xl font-semibold mb-6 tracking-wide">Categories</h2>
          ...
          <Link to="/catalog/beds">
            <li>
              <button
                className={
                  "w-full text-left px-4 py-2 rounded-md " +
                  (category === "beds" ? "bg-indigo-800" : "hover:bg-[#2a2a2a]")
                }
              >
                Beds
              </button>
        ...
        <div className="grid grid-cols-3 gap-10">
          {filteredItems?.length === 0 ? (
            ...
            filteredItems?.map((item) => (
              <FurnitureList key={item._id} id={item._id} data={item} />
            ))
          )}
        </div>
      </main>
